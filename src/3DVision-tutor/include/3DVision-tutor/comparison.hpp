...
class Tracker
{
    public:
        ...
        void extractKeypointsStella(Camera& cam)
        {
            ...
            orb_extractor.compute_image_pyramid(cam.image);
            ...
            //     cam.descriptors = out_descriptors.clone();
            // }
            ...
            for(unsigned int level = 0; level < orb_params.num_levels_; level++)
            {
                ...
                // cv::Mat descriptors_at_level = cam.descriptors.rowRange(offset, offset + num_keypts_at_level);
                ...
                cam.keypts.insert(cam.keypts.end(), keypts_at_level.begin(), keypts_at_level.end());
            }
